...
export default function Game3() {
  ...
  useEffect(() => {
    if (user) {
      ...
      //全員が決定したら遷移
      if (doneTemp === userCount * 3) {
        navigate("/Game4", { state: { id: invitationID, index: currentIndex, count: userCount, dai1: userDai[1], dai2: userDai[2], dai3: userDai[3], dai4: userDai[4], dai5: userDai[5] } });
      }
    }
  }, [done]);
                      ...
                      <Fade>
                        <div className="header">
                          ...
                          <div className="doneCount">
                            <img src={check} />{done.done - userCount * 2} / {userCount}
                          </div>
                        </div>
                        <div className="haiku">
                          <div className="haikuInputBox">
                            <h2 className="charCount"><span className="charCountNum">3</span>文字目</h2>
